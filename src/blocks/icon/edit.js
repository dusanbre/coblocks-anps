...
const bundledIconsEnabled =
	typeof anpsblocksBlockData === "undefined" ||
	anpsblocksBlockData.bundledIconsEnabled;
...
class Edit extends Component {
	componentDidMount() {
		...
		if (this.props.attributes.icon === "") {
			...
			if (
				!bundledIconsEnabled &&
				Object.keys(anpsblocksBlockData.customIcons).length
			) {
				defaultIcons = Object.keys(anpsblocksBlockData.customIcons);
			}
			const rand =
...
if ("function" === typeof wp.domReady) {
	wp.domReady(() => {
		...
		if (!bundledIconsEnabled && !anpsblocksBlockData.customIconConfigExists) {
