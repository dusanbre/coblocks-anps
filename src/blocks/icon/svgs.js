...
let icons = bundledIconsEnabled
	? {
			...
			album: {
				...
				icon: (
					<SVG viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
						<Path d="m10 0c-5.52 0-10 4.48-10 10s4.48 10 10 10 10-4.48 10-10-4.48-10-10-10zm0 14.5c-2.49 0-4.5-2.01-4.5-4.5s2.01-4.5 4.5-4.5 4.5 2.01 4.5 4.5-2.01 4.5-4.5 4.5zm0-5.5c-.55 0-1 .45-1 1s.45 1 1 1 1-.45 1-1-.45-1-1-1z" />
					</SVG>
				),
				icon_outlined: (
					<SVG viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
						<Path
							...
							transform="translate(-.289551 -.293783)"
						/>
					</SVG>
				)
			},
			...
			camera: {
				...
				icon: (
					<SVG viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
						<Path d="m7 1-1.83 2h-3.17c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2v-12c0-1.1-.9-2-2-2h-3.17l-1.83-2zm3 15c-2.76 0-5-2.24-5-5s2.24-5 5-5 5 2.24 5 5-2.24 5-5 5z" />
					</SVG>
				),
				icon_outlined: (
					<SVG viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
						<Path d="m18 3h-3.17l-1.83-2h-6l-1.83 2h-3.17c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2v-12c0-1.1-.9-2-2-2zm0 14h-16v-12h4.05l1.83-2h4.24l1.83 2h4.05zm-8-11c-2.76 0-5 2.24-5 5s2.24 5 5 5 5-2.24 5-5-2.24-5-5-5zm0 8c-1.65 0-3-1.35-3-3s1.35-3 3-3 3 1.35 3 3-1.35 3-3 3z" />
					</SVG>
				)
			},
			gallery: {
			...
			video: {
				...
				icon: (
					<SVG viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
						<G fill="currentColor" fillRule="evenodd">
							<Path d="m16 2 2 4h-3l-2-4h-2l2 4h-3l-2-4h-2l2 4h-3l-2-4h-1c-1.1 0-1.99.9-1.99 2l-.01 12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2v-14z" />
							<Path
				...
				icon_outlined: (
					<SVG viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
						<Path d="m3.76 8h14.24v8h-16v-11.53zm16.24-6h-4l2 4h-3l-2-4h-2l2 4h-3l-2-4h-2l2 4h-3l-2-4h-1c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2z" />
					</SVG>
				)
			},
			film: {
			...
			circle_add: {
				...
				icon: (
					<SVG viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
						<Path d="m10 0c-5.52 0-10 4.48-10 10s4.48 10 10 10 10-4.48 10-10-4.48-10-10-10zm5 11h-4v4h-2v-4h-4v-2h4v-4h2v4h4z" />
					</SVG>
				),
				icon_outlined: (
					<SVG viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
						<Path d="m11 5h-2v4h-4v2h4v4h2v-4h4v-2h-4zm-1-5c-5.52 0-10 4.48-10 10s4.48 10 10 10 10-4.48 10-10-4.48-10-10-10zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8z" />
					</SVG>
				)
			},
			circle_remove: {
				...
				icon: (
					<SVG viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
						<Path d="m10 0c-5.52 0-10 4.48-10 10s4.48 10 10 10 10-4.48 10-10-4.48-10-10-10zm5 11h-10v-2h10z" />
					</SVG>
				),
				icon_outlined: (
					<SVG viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
						<Path d="m5 9v2h10v-2zm5-9c-5.52 0-10 4.48-10 10s4.48 10 10 10 10-4.48 10-10-4.48-10-10-10zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8z" />
					</SVG>
				)
			},
			data_usage: {
			...
			scatter_plot: {
				...
				icon: (
					<SVG viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
						<Path d="m4.08163265 16.3265306c-2.25510204 0-4.08163265-1.8265306-4.08163265-4.0816326 0-2.25510208 1.82653061-4.08163269 4.08163265-4.08163269s4.08163266 1.82653061 4.08163266 4.08163269c0 2.255102-1.82653062 4.0816326-4.08163266 4.0816326zm7.08163265-8.16326529c-2.25510203 0-4.08163265-1.82653062-4.08163265-4.08163266s1.82653062-4.08163265 4.08163265-4.08163265c2.255102 0 4.0816327 1.82653061 4.0816327 4.08163265s-1.8265307 4.08163266-4.0816327 4.08163266zm4.7142857 11.83673469c-2.255102 0-4.0816326-1.8265306-4.0816326-4.0816327 0-2.255102 1.8265306-4.0816326 4.0816326-4.0816326 2.2551021 0 4.0816327 1.8265306 4.0816327 4.0816326 0 2.2551021-1.8265306 4.0816327-4.0816327 4.0816327z" />
					</SVG>
				),
				icon_outlined: (
					<SVG viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
			...
			emoticon: {
				...
				icon: (
					<SVG viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
						<Path d="m9.99 0c5.53 0 10.01 4.48 10.01 10s-4.48 10-10.01 10c-5.52 0-9.99-4.48-9.99-10s4.47-10 9.99-10zm3.51 9c.83 0 1.5-.67 1.5-1.5s-.67-1.5-1.5-1.5-1.5.67-1.5 1.5.67 1.5 1.5 1.5zm-7 0c.83 0 1.5-.67 1.5-1.5s-.67-1.5-1.5-1.5-1.5.67-1.5 1.5.67 1.5 1.5 1.5zm3.5 6.5c2.33 0 4.31-1.46 5.11-3.5h-10.22c.8 2.04 2.78 3.5 5.11 3.5z" />
					</SVG>
				),
				icon_outlined: (
					<SVG viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
						<Path d="m9.99 0c-5.52 0-9.99 4.48-9.99 10s4.47 10 9.99 10c5.53 0 10.01-4.48 10.01-10s-4.48-10-10.01-10zm.01 18c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8zm3.5-9c.83 0 1.5-.67 1.5-1.5s-.67-1.5-1.5-1.5-1.5.67-1.5 1.5.67 1.5 1.5 1.5zm-7 0c.83 0 1.5-.67 1.5-1.5s-.67-1.5-1.5-1.5-1.5.67-1.5 1.5.67 1.5 1.5 1.5zm3.5 6.5c2.33 0 4.31-1.46 5.11-3.5h-10.22c.8 2.04 2.78 3.5 5.11 3.5z" />
					</SVG>
				)
			},
			functions: {
			...
			font: {
				...
				icon: (
					<SVG viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
						<Path d="m7.93 11.5h4.14l-2.07-5.52zm10.07-11.5h-16c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2v-16c0-1.1-.9-2-2-2zm-4.05 16.5-1.14-3h-5.64l-1.12 3h-2.09l5.11-13h1.86l5.11 13z" />
					</SVG>
				),
				icon_outlined: (
					<SVG viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
						<Path d="m7.17 13.5h5.64l1.14 3h2.09l-5.11-13h-1.86l-5.11 13h2.09zm2.83-7.52 2.07 5.52h-4.14zm8-5.98h-16c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2v-16c0-1.1-.9-2-2-2zm0 18h-16v-16h16z" />
					</SVG>
				)
			},
			heart: {
			...
			drafts: {
				...
				icon: (
					<SVG viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
						<Path d="m19.99 7c0-.72-.37-1.35-.94-1.7l-9.05-5.3-9.05 5.3c-.57.35-.95.98-.95 1.7v11c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2zm-9.99 5-8.26-5.16 8.26-4.84 8.26 4.84z" />
					</SVG>
				),
				icon_outlined: (
					<SVG viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
						<Path d="m19.99 7c0-.72-.37-1.35-.94-1.7l-9.05-5.3-9.05 5.3c-.57.35-.95.98-.95 1.7v11c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2zm-2 0v.01l-7.99 4.99-8-5 8-4.68zm-15.99 11v-8.66l8 5.02 7.99-4.99.01 8.63z" />
					</SVG>
				)
			},
			email: {
			...
			reply_all: {
				...
				icon: (
					<SVG viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
						<Path d="m5.83333333 6.66666667v-2.5l-5.83333333 5.83333333 5.83333333 5.8333333v-2.5l-3.33333333-3.3333333zm4.99999997.83333333v-3.33333333l-5.8333333 5.83333333 5.8333333 5.8333333v-3.4166666c4.1666667 0 7.0833334 1.3333333 9.1666667 4.25-.8333333-4.1666667-3.3333333-8.33333337-9.1666667-9.1666667z" />
					</SVG>
				)
			},
			send: {
				...
				icon: (
					<SVG viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
						<G fill="currentColor" fillRule="evenodd">
							<Path d="m.00952381 18.5714286 19.99047619-8.5714286-19.99047619-8.57142857-.00952381 6.66666667 14.2857143 1.9047619-14.2857143 1.9047619z" />
							<Path
				...
				icon_outlined: (
					<SVG viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
						<Path d="m1.91428571 4.31428571 7.15238096 3.06666667-7.16190477-.95238095zm7.14285715 8.30476189-7.15238096 3.0666667v-2.1142857zm-9.04761905-11.19047617-.00952381 6.66666667 14.2857143 1.9047619-14.2857143 1.9047619.00952381 6.6666667 19.99047619-8.5714286z" />
					</SVG>
				)
			},
			signal: {
				...
				icon: (
					<SVG viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
						<Path d="m10 8.675c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm6 2c0-3.31-2.69-6-6-6s-6 2.69-6 6c0 2.22 1.21 4.15 3 5.19l1-1.74c-1.19-.7-2-1.97-2-3.45 0-2.21 1.79-4 4-4s4 1.79 4 4c0 1.48-.81 2.75-2 3.45l1 1.74c1.79-1.04 3-2.97 3-5.19zm-6-10c-5.52 0-10 4.48-10 10 0 3.7 2.01 6.92 4.99 8.65l1-1.73c-2.38-1.39-3.99-3.96-3.99-6.92 0-4.42 3.58-8 8-8s8 3.58 8 8c0 2.96-1.61 5.53-4 6.92l1 1.73c2.99-1.73 5-4.95 5-8.65 0-5.52-4.48-10-10-10z" />
					</SVG>
				)
			},
			blocks: {
				...
				icon: (
					<SVG viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
						<Path d="m10.3519669 11.7141378v8.2858622h8.2815735v-8.2858622zm-10.3519669 8.2858622h8.2815735v-8.2858622h-8.2815735zm0-18.64319006v8.28586225h8.2815735v-8.28586225zm14.1407867-1.35680994-5.8592132 5.85189021 5.8592132 5.86224759 5.8592133-5.86224759z" />
					</SVG>
				),
				icon_outlined: (
					<SVG viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
			...
			mountains: {
				...
				icon_outlined: (
					<SVG viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
						<Path d="m11.8181818 4.54545455-3.83636362 5.11818181 1.13636364 1.51818184 2.69999998-3.60909093 4.5454546 6.06363633h-7.69090913l-3.64545454-4.88181815-5.02727273 6.70000005h20zm-8.18181816 9.09090905 1.38181818-1.8454545 1.38181818 1.8454545z" />
					</SVG>
				)
			},
			waves: {
				...
				icon: (
					<SVG viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
						<Path d="m15 16.6594678c-1.35 0-2.2.42-2.95.8-.65.33-1.18.6-2.05.6-.9 0-1.4-.25-2.05-.6-.75-.38-1.57-.8-2.95-.8s-2.2.42-2.95.8c-.65.33-1.17.6-2.05.6v1.95c1.35 0 2.2-.42 2.95-.8.65-.33 1.17-.6 2.05-.6s1.4.25 2.05.6c.75.38 1.57.8 2.95.8s2.2-.42 2.95-.8c.65-.33 1.18-.6 2.05-.6.9 0 1.4.25 2.05.6.75.38 1.58.8 2.95.8v-1.95c-.9 0-1.4-.25-2.05-.6-.75-.38-1.6-.8-2.95-.8zm0-5.604419c-1.35 0-2.2.43-2.95.8-.65.32-1.18.6-2.05.6-.9 0-1.4-.25-2.05-.6-.75-.38-1.57-.8-2.95-.8s-2.2.43-2.95.8c-.65.32-1.17.6-2.05.6v1.95c1.35 0 2.2-.43 2.95-.8.65-.35 1.15-.6 2.05-.6s1.4.25 2.05.6c.75.38 1.57.8 2.95.8s2.2-.43 2.95-.8c.65-.35 1.15-.6 2.05-.6s1.4.25 2.05.6c.75.38 1.58.8 2.95.8v-1.95c-.9 0-1.4-.25-2.05-.6-.75-.38-1.6-.8-2.95-.8zm2.95-10.2550488c-.75-.38-1.58-.8-2.95-.8s-2.2.42-2.95.8c-.65.32-1.18.6-2.05.6-.9 0-1.4-.25-2.05-.6-.75-.37-1.57-.8-2.95-.8s-2.2.42-2.95.8c-.65.33-1.17.6-2.05.6v1.93c1.35 0 2.2-.43 2.95-.8.65-.33 1.17-.6 2.05-.6s1.4.25 2.05.6c.75.38 1.57.8 2.95.8s2.2-.43 2.95-.8c.65-.32 1.18-.6 2.05-.6.9 0 1.4.25 2.05.6.75.38 1.58.8 2.95.8v-1.95c-.9 0-1.4-.25-2.05-.58zm-2.95 4.65062988c-1.35 0-2.2.43-2.95.8-.65.35-1.15.6-2.05.6s-1.4-.25-2.05-.6c-.75-.38-1.57-.8-2.95-.8s-2.2.43-2.95.8c-.65.35-1.15.6-2.05.6v1.95c1.35 0 2.2-.43 2.95-.8.65-.32 1.18-.6 2.05-.6s1.4.25 2.05.6c.75.38 1.57.8 2.95.8s2.2-.43 2.95-.8c.65-.32 1.18-.6 2.05-.6.9 0 1.4.25 2.05.6.75.38 1.58.8 2.95.8v-1.95c-.9 0-1.4-.25-2.05-.6-.75-.38-1.6-.8-2.95-.8z" />
					</SVG>
				)
			},
			globe: {
				...
				icon: (
					<SVG viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
						<Path d="m10 0c-5.52 0-10 4.48-10 10s4.48 10 10 10 10-4.48 10-10-4.48-10-10-10zm-8 10c0-.61.08-1.21.21-1.78l4.78 4.78v1c0 1.1.9 2 2 2v1.93c-3.93-.5-6.99-3.86-6.99-7.93zm13.89 5.4c-.26-.81-1-1.4-1.9-1.4h-1v-3c0-.55-.45-1-1-1h-6v-2h2c.55 0 1-.45 1-1v-2h2c1.1 0 2-.9 2-2v-.41c2.93 1.18 5.01 4.06 5.01 7.41 0 2.08-.81 3.98-2.11 5.4z" />
					</SVG>
				)
			},
			city: {
			...
			build: {
				...
				icon_outlined: (
					<SVG viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
						<G fill="none" fillRule="evenodd" transform="translate(0 -.734049)">
							<Path d="m0 1h20v20h-20z" />
							<Path
			...
			layers: {
				...
				icon: (
					<SVG viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
						<Path d="m9.99610362 17.0837787-7.42990299-5.7765731-1.63316728 1.2702412 9.07315155 7.0568956 9.0731515-7.0568956-1.6432485-1.2803225zm.01008128-2.560645 7.4198217-5.77657311 1.6533298-1.28032249-9.0731515-7.05689565-9.07315155 7.05689565 1.64324856 1.28032249z" />
					</SVG>
				)
			},
			shipping: {
...
if (
	...
	Object.keys(anpsblocksBlockData.customIcons).forEach(function(key) {
		const customIcon = anpsblocksBlockData.customIcons[key].icon.replace(
			"<svg",
			'<svg data-coblocks-custom-icon="true" role="img" aria-hidden="true" focusable="false"'
		);
		anpsblocksBlockData.customIcons[key].icon = parse(customIcon);
		if ("icon_outlined" in anpsblocksBlockData.customIcons[key]) {
			const outlinedIcon = anpsblocksBlockData.customIcons[
				key
			].icon_outlined.replace(
				"<svg",
				'<svg data-coblocks-custom-icon="true" role="img" aria-hidden="true" focusable="false"'
			);
			anpsblocksBlockData.customIcons[key].icon_outlined = parse(outlinedIcon);
		}
	});
	icons = { ...icons, ...anpsblocksBlockData.customIcons };
}

Object.entries(icons).filter(function(item) {
	svgs.outlined[item[0]] = {
		icon:
			icons[item[0]] && icons[item[0]].icon_outlined
				? icons[item[0]].icon_outlined
				: icons[item[0]].icon,
