...
class Edit extends Component {
	...
	render() {
		...
		const columnOptions = [
			{
				columns: 1,
				name: __("One column", "coblocks"),
				icon: rowIcons.colOne,
				key: "100"
			},
			{
				columns: 2,
				name: __("Two columns", "coblocks"),
				icon: rowIcons.colTwo
			},
			{
				columns: 3,
				name: __("Three columns", "coblocks"),
				icon: rowIcons.colThree
			},
			{
				columns: 4,
				name: __("Four columns", "coblocks"),
				icon: rowIcons.colFour
			}
		];
			...
			return (
				<Fragment>
					...
					<Placeholder
						...
						label={
							columns ? __("Row layout", "coblocks") : __("Row", "coblocks")
						}
						instructions={
							columns
								? sprintf(
					...
					>
						{!columns ? (
							<ButtonGroup
								aria-label={__("Select row columns", "coblocks")}
								className="block-editor-inner-blocks__template-picker-options block-editor-block-pattern-picker__patterns"
							>
							...
							<Fragment>
								<ButtonGroup
									aria-label={__("Select row layout", "coblocks")}
									className="block-editor-inner-blocks__template-picker-options block-editor-block-pattern-picker__patterns"
								>
									<IconButton
										icon="exit"
