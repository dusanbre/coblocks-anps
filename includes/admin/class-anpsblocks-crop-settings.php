...
class CoBlocks_Crop_Settings
{
	...
	public function register_endpoints()
	{
		...
		add_action('wp_ajax_anpsblocks_crop_settings', array($this, 'api_crop'));
		add_action('wp_ajax_anpsblocks_crop_settings_original_image', array($this, 'get_original_image'));
	}
	...
	public function hide_cropped_from_library($query)
	{
		...
		$tag = get_term_by('slug', 'anpsblocks-cropped', 'post_tag');
	...
	public function image_media_crop($id, $offset_x, $offset_y, $width, $height, $rotate)
	{
		...
		wp_set_post_tags($attachment_id, 'anpsblocks-cropped', true);
